...
!(function (t) {
  ...
  (v.prototype = {
    ...
    open: function (i) {
      ...
      if (!e.isOpen) {
        (e.types = []),
          ...
          e.bgOverlay ||
            ((e.bgOverlay = w("bg").on("click.mfp", function () {
              e.close();
            })),
            (e.wrap = w("wrap")
              .attr("tabindex", -1)
    ...
    _hasScrollBar: function (t) {
      return (
        (e.isIE7 ? n.height() : document.body.scrollHeight) > (t || b.height())
      );
    },
    _setFocus: function () {
      ...
      getInline: function (i, n) {
        if ((E(), i.src)) {
          ...
          if (s.length) {
            ...
            r &&
              r.tagName &&
              (k || ((T = o.hiddenClass), (k = w(T)), (T = "mfp-" + T)),
              (A = s.after(k).detach().removeClass(T))),
      ...
      initRetina: function () {
        if (window.devicePixelRatio > 1) {
          var t = e.st.retina,
            i = t.ratio;
          (i = isNaN(i) ? i() : i) > 1 &&
            (x("ImageHasSize.retina", function (t, e) {
              e.img.css({
                "max-width": e.img[0].naturalWidth / i,
                width: "100%",
              });
            }),
            x("ElementParse.retina", function (e, n) {
  ...
  (function (t, e) {
    ...
    var _ =
      ...
      (function (t) {
        ...
        try {
          O.apply((P = F.call(w.childNodes)), w.childNodes),
        ...
        (at.attr = function (t, e) {
          ...
          var o = n.attrHandle[e.toLowerCase()],
            s =
              o && E.call(n.attrHandle, e.toLowerCase()) ? o(t, e, !m) : void 0;
          return void 0 !== s
            ? s
            : i.attributes || !m
            ? t.getAttribute(e)
          ...
          return (
            ...
            ct(function (s, r, a, l) {
              var c,
                ...
                g = !t || (!s && e) ? m : Ct(m, p, t, a, l),
                v = i ? (o || (s ? t : f || n) ? [] : r) : g;
              if ((i && i(g, v, a, l), n))
                for (c = Ct(v, h), n(c, [], a, l), d = c.length; d--; )
                  (u = c[d]) && (v[h[d]] = !(g[h[d]] = u));
              if (s) {
                if (o || t) {
                  if (o) {
              ...
              } else (v = Ct(v === r ? v.splice(f, v.length) : v)), o ? o(null, r, v, l) : O.apply(r, v);
            })
          );
        }
        function St(t) {
          for (
            ...
            if ((i = n.relative[t[l].type])) p = [xt(wt(p), i)];
            else {
        ...
        return (
          ...
          (i.sortStable = x.split("").sort($).join("") === x),
    ...
    (w.filter = function (t, e, i) {
      ...
      w.fn.extend({
        ...
        is: function (t) {
          return !!E(
            this,
            "string" == typeof t && k.test(t) ? w(t) : t || [],
            !1
          ).length;
        },
      });
      ...
      if (((i = i || P), "string" == typeof t)) {
        ...
        if (n[1]) {
          if (
            ...
            w.merge(
              this,
              w.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : g, !0)
            ),
            $.test(n[1]) && w.isPlainObject(e))
          )
            for (n in e) f(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
          return this;
        }
        return (
          (o = g.getElementById(n[2])) && ((this[0] = o), (this.length = 1)),
          this
        );
      }
      return t.nodeType
        ...
        function (t, e) {
          w.fn[t] = function (i, n) {
            ...
            return (
              ...
              this.length > 1 &&
                (O[t] || w.uniqueSort(o), D.test(t) && o.reverse()),
              this.pushStack(o)
            );
          };
        }
          ...
          var i = [
            ...
            o = {
              ...
              then: function (e, n, o) {
                ...
                return w
                  .Deferred(function (t) {
                    i[0][3].add(r(0, t, f(o) ? o : N, t.notifyWith)),
                      i[1][3].add(r(0, t, f(e) ? e : N)),
                      i[2][3].add(r(0, t, f(n) ? n : j));
                  })
                  .promise();
              },
              promise: function (t) {
      ...
      w.extend({
        ...
        ready: function (t) {
          (!0 === t ? --w.readyWait : w.isReady) ||
            ((w.isReady = !0),
            (!0 !== t && --w.readyWait > 0) || H.resolveWith(g, [w]));
        },
      }),
      (w.ready.then = H.then),
    ...
    var q = function (t, e, i, n, o, s, r) {
        var a = 0,
          ...
          c = null == i;
        if ("object" === b(i))
          for (a in ((o = !0), i)) q(t, e, a, i[a], !0, s, r);
        else if (
          void 0 !== n &&
          ((o = !0),
          f(n) || (r = !0),
    ...
    (ut = g.createDocumentFragment().appendChild(g.createElement("div"))),
      ...
      return (
        (i =
          void 0 !== t.getElementsByTagName
            ...
            : []),
        void 0 === e || (e && A(t, e)) ? w.merge([t], i) : i
      );
    }
    function yt(t, e) {
    ...
    function xt(t, e, i, n, o) {
      ...
      for (u.textContent = "", h = 0; (s = p[h++]); )
        if (n && w.inArray(s, n) > -1) o && o.push(s);
          ...
          ((c = ot(s)), (r = vt(u.appendChild(s), "script")), c && yt(r), i)
        )
      ...
      special: {
        ...
        click: {
          setup: function (t) {
            var e = this || t;
            return (
              ht.test(e.type) && e.click && A(e, "input") && kt(e, "click", Ct),
              !1
            );
          },
          trigger: function (t) {
            var e = this || t;
            return (
              ht.test(e.type) && e.click && A(e, "input") && kt(e, "click"), !0
            );
          },
          _default: function (t) {
            var e = t.target;
      ...
      if (1 === e.nodeType) {
        if (G.hasData(t) && (a = G.get(t).events))
          for (o in (G.remove(e, "handle events"), a))
            for (i = 0, n = a[o].length; i < n; i++) w.event.add(e, o, a[o][i]);
    ...
    function Mt(t, e, i, n) {
      ...
      var o,
        ...
        g = e[0],
        v = f(g);
      if (v || (p > 1 && "string" == typeof g && !h.checkClone && $t.test(g)))
        return t.each(function (o) {
          var s = t.eq(o);
          v && (e[0] = g.call(this, o, s.html())), Mt(s, e, i, n);
        });
      if (
        p &&
        ((r = (o = xt(e, t[0].ownerDocument, !1, t, n)).firstChild),
        1 === o.childNodes.length && (o = r),
        r || n)
      ) {
        for (l = (a = w.map(vt(o, "script"), It)).length; u < p; u++)
          (c = o),
            u !== m &&
        ...
        if (l)
          for (
            d = a[a.length - 1].ownerDocument, w.map(a, Dt), u = 0;
            u < l;
            u++
          )
            (c = a[u]),
              mt.test(c.type || "") &&
                ...
                (c.src && "module" !== (c.type || "").toLowerCase()
                  ...
                  : y(c.textContent.replace(Et, ""), c, d));
      }
      return t;
    }
    function Nt(t, e, i) {
      for (var n, o = e ? w.filter(e, t) : t, s = 0; null != (n = o[s]); s++)
        i || 1 !== n.nodeType || w.cleanData(vt(n)),
          n.parentNode &&
            (i && ot(n) && yt(vt(n, "script")), n.parentNode.removeChild(n));
      return t;
    }
    w.extend({
      ...
      clone: function (t, e, i) {
        ...
        if (
          ...
          for (r = vt(a), n = 0, o = (s = vt(t)).length; n < o; n++)
            Ft(s[n], r[n]);
        if (e)
          if (i)
            for (
              s = s || vt(t), r = r || vt(a), n = 0, o = s.length;
              n < o;
              n++
            )
              Ot(s[n], r[n]);
        ...
        return (
          (r = vt(a, "script")).length > 0 && yt(r, !l && vt(t, "script")), a
        );
      },
      cleanData: function (t) {
        for (
          var e, i, n, o = w.event.special, s = 0;
          void 0 !== (i = t[s]);
          s++
        )
          if (Y(i)) {
        ...
        replaceWith: function () {
          ...
          return Mt(
            ...
            function (e) {
              ...
              w.inArray(this, t) < 0 &&
                (w.cleanData(vt(this)), i && i.replaceChild(e, this));
            },
            t
          );
        },
      ...
      w.each(
        ...
        function (t, e) {
          w.fn[t] = function (t) {
            for (var i, n = [], o = w(t), s = o.length - 1, a = 0; a <= s; a++)
    ...
    function Qt(t, e, i, n, o, s) {
      ...
      for (; r < 4; r += 2)
        "margin" === i && (l += w.css(t, i + it[r], !0, o)),
          n
            ? ("content" === i && (l -= w.css(t, "padding" + it[r], !0, o)),
              "margin" !== i &&
                (l -= w.css(t, "border" + it[r] + "Width", !0, o)))
            : ((l += w.css(t, "padding" + it[r], !0, o)),
              "padding" !== i
                ? (l += w.css(t, "border" + it[r] + "Width", !0, o))
                : (a += w.css(t, "border" + it[r] + "Width", !0, o)));
      return (
        !n &&
          s >= 0 &&
          (l +=
    ...
    function Jt(t, e, i) {
      ...
      return (
        ((!h.boxSizingReliable() && o) ||
          ...
          (s = a in t) && (r = t[a])),
        (r = parseFloat(r) || 0) +
          Qt(t, e, i || (o ? "border" : "content"), s, n, r) +
          "px"
      );
    }
    ...
    w.extend({
      ...
      w.each(["height", "width"], function (t, e) {
        w.cssHooks[e] = {
          get: function (t, i, n) {
            if (i)
              return !Yt.test(w.css(t, "display")) ||
          ...
          set: function (t, i, n) {
            var o,
              ...
              a = (r || n) && "border-box" === w.css(t, "boxSizing", !1, s),
              l = n ? Qt(t, e, n, a, s) : 0;
            return (
              a &&
                r &&
    ...
    function ce(t, e, i) {
      ...
      for (
        ...
        if ((n = ce.prefilters[s].call(c, t, d, c.opts)))
          return (
            f(n.stop) &&
            ...
            h))
              l ||
                (g
                  ...
                  : (g = G.access(t, "fxshow", { display: c })),
                s && (g.hidden = !m),
                m && dt([t], !0),
                p.done(function () {
                  for (n in (m || dt([t]), G.remove(t, "fxshow"), h))
                    w.style(t, n, h[n]);
                })),
                (l = le(m ? g[n] : 0, n, p)),
                n in g ||
        ...
        toggleClass: function (t, e) {
          ...
          return "boolean" == typeof e && n
            ...
            ? this.each(function (i) {
                w(this).toggleClass(t.call(this, i, me(this), e), e);
              })
            : this.each(function () {
                var e, o, s, r;
                if (n)
                  for (o = 0, s = w(this), r = ge(t); (e = r[o++]); )
                    s.hasClass(e) ? s.removeClass(e) : s.addClass(e);
                else
                  (void 0 !== t && "boolean" !== i) ||
                    ((e = me(this)) && G.set(this, "__className__", e),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
          ...
          return (
            ...
            o ||
              ...
              (c &&
                ...
                ((a = n[c]) && (n[c] = null),
                (w.event.triggered = y),
                e.isPropagationStopped() && h.addEventListener(y, be),
                n[y](),
                e.isPropagationStopped() && h.removeEventListener(y, be),
    ...
    function Ae(t, e, i, n) {
      ...
      else for (o in e) Ae(t + "[" + o + "]", e[o], i, n);
    }
              ...
              u
                ? (h.ifModified &&
                  ...
                  204 === e || "HEAD" === h.type
                    ...
                    : 304 === e
                    ? (_ = "notmodified")
                    : ((_ = x.state), (p = x.data), (u = !(g = x.error))))
                : ((g = _), (!e && _) || ((_ = "error"), e < 0 && (e = 0))),
              (S.status = e),
              (S.statusText = (i || _) + ""),
              u ? v.resolveWith(f, [p, _, S]) : v.rejectWith(f, [S, _, g]),
              S.statusCode(b),
              (b = void 0),
              d &&
                m.trigger(u ? "ajaxSuccess" : "ajaxError", [S, h, u ? p : g]),
              y.fireWith(f, [S, _]),
              d &&
    ...
    w.ajaxSetup({
      ...
      (h.createHTMLDocument =
        (((ze = g.implementation.createHTMLDocument("").body).innerHTML =
          "<form></form><form></form>"),
      ...
      (w.fn.load = function (t, e, i) {
        var n,
          ...
          a = t.indexOf(" ");
        return (
          a > -1 && ((n = fe(t.slice(a))), (t = t.slice(0, a))),
          f(e)
            ? ((i = e), (e = void 0))
      ...
      w.each(["top", "left"], function (t, e) {
        w.cssHooks[e] = qt(h.pixelPosition, function (t, i) {
          if (i)
            return (i = Bt(t, e)), jt.test(i) ? w(t).position()[e] + "px" : i;
        });
      }),
    ...
    return (
      (w.noConflict = function (e) {
        return (
          t.$ === w && (t.$ = Ve), e && t.jQuery === w && (t.jQuery = Ye), w
        );
      }),
    ...
    !(function () {
        ...
        Object.keys ||
          (Object.keys =
            ...
            function (t) {
              ...
              if (i) for (a = 0; a < o; a++) s.call(t, n[a]) && e.push(n[a]);
              return e;
            })),
        Array.isArray ||
      ...
      (e = function (n, o, s) {
        ...
        if (
          ...
          h = d.querySelectorAll(n);
        else if (n && "object" == typeof n && i.isElement(n, d)) h = [n];
        else {
        ...
        for (f = 0; (r = h[f]) && (!(f > 0) || a); f++)
          r.id ? (p = r.id) : ((p = "MixItUp" + i.randomHex()), (r.id = p)),
      ...
      (i = {
        ...
        handleExtendError: function (t, i) {
          ...
          if (
            ...
            (n = /property "?(\w*)"?[,:] object/i.exec(t.message))
          ) {
            for (l in ((o = n[1]), i)) {
        ...
        createElement: function (e, i) {
          var n = null,
            o = null;
          for (
            n = (i = i || t.document).createDocumentFragment(),
              (o = i.createElement("div")).innerHTML = e.trim();
            o.firstChild;
        ...
        arrayShuffle: function (t) {
          for (var e = t.slice(), i = e.length, n = i, o = -1, s = []; n--; )
            (o = ~~(Math.random() * i)), (s = e[n]), (e[n] = e[o]), (e[o] = s);
          return e;
        },
        ...
        position: function (t) {
          for (var e = 0, i = 0, n = t; t; )
            (e -= t.scrollLeft),
              (i -= t.scrollTop),
              t === n &&
                ((e += t.offsetLeft), (i += t.offsetTop), (n = t.offsetParent)),
              (t = t.parentElement);
          return { x: e, y: i };
        },
        ...
        isVisible: function (e) {
          ...
          return (
            !!e.offsetParent ||
            ("fixed" === (i = t.getComputedStyle(e)).position &&
              "hidden" !== i.visibility &&
              "0" !== i.opacity)
          );
        },
        ...
        compareVersions: function (t, e) {
          ...
          for (r = 0; r < i.length; r++) {
            if (
              ((o = parseInt(i[r].replace(/[^\d.]/g, ""))),
              (s = parseInt(n[r].replace(/[^\d.]/g, "") || 0)) < o)
            )
              return !1;
            if (s > o) return !0;
          }
      ...
      (e.Base.prototype = {
        ...
        callFilters: function (t, e, n) {
          ...
          for (r in ((n = n || []), o))
            (n = i.arrayFromList(n)).unshift(s), (s = o[r].apply(this, n));
          return s;
        },
      }),
      ...
      i.extend(e.Control.prototype, {
        ...
        removeBinding: function (t) {
          ...
          this.callActions("beforeRemoveBinding", arguments),
            (n = i.bound.indexOf(t)) > -1 && i.bound.splice(n, 1),
            i.bound.length < 1 &&
              (i.unbindClick(),
              (n = e.controls.indexOf(i)),
              e.controls.splice(n, 1),
          ...
          if (
            ...
            switch (n.type) {
              ...
              case "multimix":
                ...
                break;
              case "toggle":
                (a.filter = n.filter || o.getAttribute("data-toggle")),
                  (r =
                    "live" === n.status
                      ? i.hasClass(o, n.classNames.active)
                      : "active" === n.status);
            }
            for (d = 0; d < n.bound.length; d++)
              (l = new e.CommandMultimix()), i.extend(l, a), c.push(l);
            for (
              c = n.callFilters("commandsHandleClick", c, arguments),
          ...
          n.callActions("beforeUpdate", arguments),
            ...
            n.pending > 0 ||
              ("live" === n.status
                ...
                : ((o.sort = n.sort),
                  (o.filter = n.filter),
                  n.callFilters("actionsUpdate", o, arguments),
                  n.parseStatusChange(n.el, t, o, i)),
        ...
        updateLive: function (t, i) {
          ...
          if ((n.callActions("beforeUpdateLive", arguments), n.el)) {
            for (
              o = n.el.querySelectorAll(n.selector), a = 0;
              (r = o[a]);
              a++
            ) {
        ...
        parseStatusChange: function (t, e, i, n) {
          ...
          switch (
            ...
            case "toggle":
              for (
                n.length < 1 && o.renderStatus(t, "inactive"),
      ...
      i.extend(e.Mixer.prototype, {
          ...
          for (
            a.callActions("beforeAttach", arguments),
              ...
              a.config.layout.containerClassName &&
                i.addClass(a.dom.container, a.config.layout.containerClassName),
        ...
        getInitialState: function () {
          ...
          if (
            ...
            (i.activeContainerClassName = t.config.layout.containerClassName),
            ...
            (i.activeFilter = t.parseFilterArgs([
          ...
          return (
            (n = t.callFilters("operationGetInitialState", n, [i])),
            (t.lastOperation = n),
            n.newFilter && t.filterOperation(n),
            (i = t.buildState(n))
          );
        },
        ...
        indexTargets: function () {
          ...
          if (t.dom.targets.length) {
            for (r = 0; (o = t.dom.targets[r]); r++)
              (n = new e.Target()).init(o, t, s ? s[r] : void 0),
                (n.isInDom = !0),
                t.targets.push(n);
            t.dom.parent =
        ...
        initControls: function () {
          ...
          for (l = 0; (i = e.controlDefinitions[l]); l++)
            if (t.config.controls.live || i.live) {
              ...
              for (c = 0; (o = r[c]); c++)
                (a = t.getControl(o, i.type, i.selector)), t.controls.push(a);
            } else
              for (
                n = s.querySelectorAll(t.config.selectors.control + i.selector),
                  c = 0;
                (o = n[c]);
                c++
              )
                (a = t.getControl(o, i.type, "")) && t.controls.push(a);
        ...
        getControl: function (t, n, o) {
          ...
          if ((s.callActions("beforeGetControl", arguments), !o))
            for (a = 0; (r = e.controls[a]); a++) {
              ...
              if (r.el === t && r.type === n && r.selector === o)
                return (
                  r.addBinding(s),
          ...
          return (
            ...
            (r.classNames.active = i.getClassname(
              s.config.classNames,
              n,
              s.config.classNames.modifierActive
            )),
            (r.classNames.disabled = i.getClassname(
              s.config.classNames,
              n,
        ...
        buildToggleArray: function (t, e) {
          var n = this,
            o = "";
          if (
            (n.callActions("beforeBuildToggleArray", arguments), t && t.filter)
          )
          ...
          (o !== n.config.selectors.target && "all" !== o) || (o = ""),
            "or" === n.config.controls.toggleLogic
              ? (n.toggleArray = o.split(","))
              : (n.toggleArray = n.splitCompoundSelector(o)),
        ...
        updateControls: function (t) {
          ...
          for (
            n.callActions("beforeUpdateControls", arguments),
              ...
              t.sort
                ? (s.sort = n.buildSortString(t.sort))
        ...
        insertTargets: function (t, n) {
          ...
          if (
            ...
            (r = s ? i.index(s, o.config.selectors.target) : o.targets.length),
            t.collection)
          ) {
        ...
        getNextSibling: function (t, e, i) {
          ...
          return (
            ...
            e && "before" === i
              ...
              : n.targets.length > 0 && void 0 !== t
              ? (o =
                  t < n.targets.length || !n.targets.length
                    ? n.targets[t].dom.el
                    : n.targets[n.targets.length - 1].dom.el.nextElementSibling)
              : 0 === n.targets.length &&
                n.dom.parent.children.length > 0 &&
                (n.config.layout.siblingAfter
                  ? (o = n.config.layout.siblingAfter)
                  : n.config.layout.siblingBefore
                  ? (o = n.config.layout.siblingBefore.nextElementSibling)
        ...
        filterOperation: function (t) {
          ...
          for (
            ...
            (i = t.newFilter.collection
              ...
              e.evaluateHideShow(i, s, o, t);
          if (t.toRemove.length)
            for (r = 0; (s = t.show[r]); r++)
              t.toRemove.indexOf(s) > -1 &&
                (t.show.splice(r, 1),
                (n = t.toShow.indexOf(s)) > -1 && t.toShow.splice(n, 1),
                t.toHide.push(s),
                t.hide.push(s),
                r--);
        ...
        getAttributeValue: function (t, i) {
          var n = this,
            o = "";
          return (
            null === (o = t.dom.el.getAttribute("data-" + i)) &&
            ...
            n.callFilters("valueGetAttributeValue", o || 0, arguments)
          );
        },
        printSort: function (e, n) {
          var o = this,
            s = e ? n.newOrder : n.startOrder,
            r = e ? n.startOrder : n.newOrder,
            ...
            p = -1;
          for (
            o.callActions("beforePrintSort", arguments), p = 0;
            (d = s[p]);
            p++
          )
            "absolute" !== (u = d.dom.el).style.position &&
              (i.removeWhitespace(u.previousSibling),
        ...
        parseSortString: function (t, n) {
          ...
          for (l = 0; l < s.length; l++) {
            ...
            l < s.length - 1 &&
              ((r.next = new e.CommandSort()), i.freeze(r), (r = r.next));
          }
          return o.callFilters("commandsParseSort", n, arguments);
        },
        parseEffects: function () {
          ...
          e.transformDefaults))
            e.transformDefaults[i] instanceof e.TransformData &&
              (t.parseEffect(i, n, t.effectsIn, t.transformIn),
              t.parseEffect(i, o, t.effectsOut, t.transformOut, !0));
        ...
        parseEffect: function (t, i, n, o, s) {
          ...
          if (i.indexOf(t) < 0) "stagger" === t && (r.staggerDuration = 0);
          else {
            switch (
              ((l = i.indexOf(t + "(")) > -1 &&
                ((c = i.substring(l)), (d = a.exec(c)[1])),
              t)
            ) {
              case "fade":
        ...
        goMix: function (n, o) {
          ...
          return (
            ...
            (r = s.userDeferred
              ? s.userDeferred
              : (s.userDeferred = i.defer(e.libraries))),
            (s.isBusy = !0),
        ...
        getStartMixData: function (i) {
          ...
          for (
            n.incPadding = "border-box" === c,
              n.callActions("beforeGetStartMixData", arguments),
              l = 0;
            (r = i.show[l]);
            l++
          )
            (a = r.getPosData()), (i.showPosData[l] = { startPosData: a });
          for (l = 0; (r = i.toHide[l]); l++)
            (a = r.getPosData()), (i.toHidePosData[l] = { startPosData: a });
          (i.startX = s.left),
            (i.startY = s.top),
        ...
        getInterMixData: function (t) {
          var e = this,
            ...
            n = -1;
          for (
            e.callActions("beforeGetInterMixData", arguments), n = 0;
            (i = t.show[n]);
            n++
          )
            t.showPosData[n].interPosData = i.getPosData();
          for (n = 0; (i = t.toHide[n]); n++)
            t.toHidePosData[n].interPosData = i.getPosData();
        ...
        getFinalMixData: function (e) {
            ...
            (n.config.animation.clampHeight || n.config.animation.clampWidth) &&
              (n.dom.parent.style.height =
                ...
                n.dom.parent.style.overflow =
                  ""),
              n.incPadding || (o = t.getComputedStyle(n.dom.parent)),
              s = n.dom.parent.getBoundingClientRect(),
              e.newX = s.left,
              e.newY = s.top,
          ...
          e.willChangeLayout &&
            (i.removeClass(n.dom.container, e.newContainerClassName),
        ...
        getTweenData: function (t) {
          var i = this,
            ...
            u = -1;
          for (
            i.callActions("beforeGetTweenData", arguments), d = 0;
            (n = t.show[d]);
            d++
          )
            for (
        ...
        moveTargets: function (t) {
          ...
          for (
            n.callActions("beforeMoveTargets", arguments), d = 0;
            (o = t.show[d]);
            d++
          )
            (s = new e.IMoveData()),
          ...
          n.config.animation.animateResizeContainer &&
            ((n.dom.parent.style[e.features.transitionProp] =
              "height " +
            ...
            requestAnimationFrame(function () {
              t.startHeight !== t.newHeight &&
                ...
                (n.dom.parent.style.height = t.newHeight + "px"),
                t.startWidth !== t.newWidth &&
                  t.viewportDeltaX !== t.startWidth - t.newWidth &&
                  (n.dom.parent.style.width = t.newWidth + "px");
            })),
            t.willChangeLayout &&
              (i.removeClass(
                n.dom.container,
              ...
              i.addClass(n.dom.container, t.newContainerClassName)),
        ...
        hasEffect: function () {
          ...
          for (s = 0; (i = e[s]); s++)
            if (
              0 !== ("undefined" !== (n = t.effectsIn[i]).value ? n.value : n)
            ) {
              o = !0;
              break;
            }
            ...
            (r =
              ...
              (!!(("none" !== t && e) || n.x !== o.x || n.y !== o.y) ||
                (!!s.config.animation.animateResizeTargets &&
                  (n.width !== o.width ||
                    n.height !== o.height ||
                    n.marginRight !== o.marginRight ||
                    n.marginTop !== o.marginTop)))),
        ...
        cleanUp: function (t) {
          ...
          if (
            ...
            (n.dom.parent.style[e.features.transitionProp] =
              ...
              n.dom.parent.style.width =
              n.dom.parent.style.overflow =
              n.dom.parent.style[e.features.perspectiveProp] =
              n.dom.parent.style[e.features.perspectiveOriginProp] =
                ""),
            t.willChangeLayout &&
              (i.removeClass(n.dom.container, t.startContainerClassName),
              i.addClass(n.dom.container, t.newContainerClassName)),
            t.toRemove.length)
          ) {
          ...
          t.willSort && (n.targets = t.newOrder),
            ...
            n.queue.length &&
              ...
              a.instruction.command instanceof e.CommandMultimix
                ? n.multimix.apply(n, a.args)
                : n.dataset.apply(n, a.args)),
        ...
        parseMultimixArgs: function (t) {
          ...
          return (
            !o.command.insert ||
              ...
              (o.command.insert = n.parseInsertArgs([
                o.command.insert,
              ]).command),
            !o.command.remove ||
              o.command.remove instanceof e.CommandRemove ||
              (o.command.remove = n.parseRemoveArgs([
                o.command.remove,
              ]).command),
            !o.command.filter ||
              o.command.filter instanceof e.CommandFilter ||
              (o.command.filter = n.parseFilterArgs([
                o.command.filter,
              ]).command),
            !o.command.sort ||
              o.command.sort instanceof e.CommandSort ||
              (o.command.sort = n.parseSortArgs([o.command.sort]).command),
            !o.command.changeLayout ||
              o.command.changeLayout instanceof e.CommandChangeLayout ||
              (o.command.changeLayout = n.parseChangeLayoutArgs([
                o.command.changeLayout,
              ]).command),
            (o = n.callFilters("instructionParseMultimixArgs", o, arguments)),
            i.freeze(o),
            o
          );
        },
        parseFilterArgs: function (t) {
          ...
          for (
            ...
            "string" == typeof (s = t[r])
              ...
              ? (o.command.collection = i.arrayFromList(s))
              : "object" == typeof s
              ? i.extend(o.command, s)
              : "boolean" == typeof s
              ? (o.animate = s)
          ...
          return (
            (o = n.callFilters("instructionParseFilterArgs", o, arguments)),
            i.freeze(o),
            o
          );
        },
        parseSortArgs: function (t) {
            ...
            if (null !== (s = t[a]))
              switch (typeof s) {
                case "string":
                  ...
                  break;
                case "object":
                  s.length && (o.command.collection = i.arrayFromList(s));
                  break;
                case "boolean":
                  o.animate = s;
                  break;
          ...
          return (
            r && (o.command = n.parseSortString(r, o.command)),
            (o = n.callFilters("instructionParseSortArgs", o, arguments)),
            i.freeze(o),
            o
          );
        },
        parseInsertArgs: function (t) {
          ...
          for (
            ...
            null !== (s = t[r]) &&
              ("number" == typeof s
                ...
                : "string" == typeof s
                ? (o.command.collection = i.arrayFromList(
                ...
                ? o.command.collection.length
                  ...
                  : (o.command.collection = i.arrayFromList(s.childNodes))
                : "object" == typeof s
                ? i.extend(o.command, s)
                : "boolean" == typeof s
                ? (o.animate = s)
          ...
          return (
            ...
            (o = n.callFilters("instructionParseInsertArgs", o, arguments)),
            i.freeze(o),
            o
          );
        },
        parseRemoveArgs: function (t) {
          ...
          for (
            ...
            if (null !== (r = t[a]))
              switch (typeof r) {
                case "number":
                  n.targets[r] && (o.command.targets[0] = n.targets[r]);
                  break;
                case "string":
                  o.command.collection = i.arrayFromList(
                    n.dom.parent.querySelectorAll(r)
                  );
                  break;
                case "object":
                  r && r.length
                    ? (o.command.collection = r)
                    : i.isElement(r, n.dom.document)
                    ? (o.command.collection = [r])
                    : i.extend(o.command, r);
                  break;
                case "boolean":
                  o.animate = r;
                  break;
          ...
          if (o.command.collection.length)
            for (a = 0; (s = n.targets[a]); a++)
              o.command.collection.indexOf(s.dom.el) > -1 &&
                o.command.targets.push(s);
          return (
        ...
        parseDatasetArgs: function (t) {
          ...
          for (
            n.animate = this.config.animation.enable,
              n.command = new e.CommandDataset(),
              s = 0;
            s < t.length;
            s++
          )
        ...
        parseChangeLayoutArgs: function (t) {
          ...
          for (
            n.animate = this.config.animation.enable,
              n.command = new e.CommandChangeLayout(),
              s = 0;
            s < t.length;
            s++
          )
                ...
                n.config.controls.enable &&
                  (n.isToggling
                    ? (n.buildToggleArray(t.instruction.command),
                      ...
                      n.updateControls({ filter: { selector: s } }))
        ...
        getDataOperation: function (t) {
          ...
          return (
            ...
            (o = n.callFilters("operationMappedGetDataOperation", o, arguments))
          );
        },
        diffDatasets: function (t) {
          var n = this,
            ...
            f = -1;
          for (
            n.callActions("beforeDiffDatasets", arguments), f = 0;
            (a = t.newDataset[f]);
            f++
          ) {
            if (
              void 0 === (h = a[n.config.data.uidKey]) ||
              h.toString().length < 1
            )
              throw new TypeError(
            ...
            (p[h] = !0),
              (l = n.cache[h]) instanceof e.Target
                ? (n.config.data.dirtyCheck &&
                    ...
                    c !== l.dom.el &&
                      (l.isInDom &&
                        (l.unbindEvents(),
                        n.dom.parent.replaceChild(c, l.dom.el)),
              ...
              l.isInDom
                ? ((u = l.dom.el.nextElementSibling),
                  ...
                  d &&
                    (d.lastElementChild &&
                      d.appendChild(n.dom.document.createTextNode(" ")),
                    n.insertDatasetFrag(d, l.dom.el, r),
                    (d = null)))
                : (d || (d = n.dom.document.createDocumentFragment()),
                  d.lastElementChild &&
                    d.appendChild(n.dom.document.createTextNode(" ")),
          ...
          for (
            d &&
              ((u = u || n.config.layout.siblingAfter) &&
                d.appendChild(n.dom.document.createTextNode(" ")),
              n.insertDatasetFrag(d, u, r)),
              f = 0;
            (a = t.startDataset[f]);
            f++
          )
            (h = a[n.config.data.uidKey]),
              (l = n.cache[h]),
              t.show.indexOf(l) < 0
                ? (t.hide.push(l), t.toHide.push(l), t.toRemove.push(l))
                : o.push(h);
          i.isEqualArray(o, s) || (t.willSort = !0),
            n.callActions("afterDiffDatasets", arguments);
        },
        insertDatasetFrag: function (t, e, n) {
          var o = this,
            s = e
              ? i.arrayFromList(o.dom.parent.children).indexOf(e)
              : o.targets.length;
          for (o.dom.parent.insertBefore(t, e); n.length; )
            o.targets.splice(s, 0, n.shift()), s++;
        },
        willSort: function (t, e) {
          ...
          return (
            (n =
              ...
              (!(!t.next || !e.next) && i.willSort(t.next, e.next))),
        ...
        toggleOn: function () {
          ...
          return (
            (t.isToggling = !0),
            t.toggleArray.indexOf(i) < 0 && t.toggleArray.push(i),
          ...
          return (
            ...
            t.isBusy
              ? (((o = new e.QueueItem()).args = arguments),
                (o.instruction = i),
                t.queueMix(o))
              : (i.callback && (t.userCallback = i.callback),
                (s =
                  i.animate ^ t.config.animation.enable
                    ? i.animate
                    : t.config.animation.enable),
                (n = t.getDataOperation(i.command.dataset)),
                t.goMix(s, n))
          );
        },
        multimix: function () {
            ...
            t.isBusy
              ...
              : ((i = t.getOperation(s.command)),
                t.config.controls.enable &&
                  (s.command.filter &&
                    !t.isToggling &&
                    ((t.toggleArray.length = 0), t.buildToggleArray(i.command)),
                  t.queue.length < 1 && t.updateControls(i.command)),
            ...
            n.isBusy
              ...
              : (l && n.insertTargets(l, c),
                ...
                o &&
                  ...
                  (c.newSort = o),
                  (c.willSort = n.willSort(o, c.startState.activeSort)),
                  c.willSort && n.sortOperation(c)),
                (c.startFilter = c.startState.activeFilter),
                (c.newFilter =
                  s || i.extend(new e.CommandFilter(), c.startFilter)),
                "all" === c.newFilter.selector
                  ? (c.newFilter.selector = n.config.selectors.target)
        ...
        getState: function () {
          ...
          return (
            ...
            i.extend(n, t.state),
            i.freeze(n),
            t.callFilters("stateGetState", n, arguments)
          );
        },
        ...
        forceRender: function () {
          var t = this,
            ...
            n = "";
          for (n in t.cache)
            (i = (e = t.cache[n]).render(e.data)) !== e.dom.el &&
              (e.isInDom &&
        ...
        destroy: function (t) {
          ...
          for (
            ...
            n.removeBinding(i);
          for (s = 0; (o = i.targets[s]); s++) t && o.show(), o.unbindEvents();
      ...
      i.extend(e.Target.prototype, {
        ...
        render: function (t) {
          ...
          return (
            (a = o(t)) && "object" == typeof a && i.isElement(a)
              ? (s = a)
              : "string" == typeof a &&
        ...
        applyTween: function (t, i) {
          ...
          for (
            ...
            if (((s = t.tweenData[o]), "x" === o)) {
              ...
              if (!s.value) continue;
              (l[o].value = r[o].value + s.value * i),
                (l[o].unit = s.unit),
                a.push(o + "(" + l[o].value + s.unit + ")");
            } else {
              if (!s) continue;
              (l[o] = r[o] + s * i), (n.dom.el.style[o] = l[o]);
            }
          (l.x || l.y) && a.unshift("translate(" + l.x + "px, " + l.y + "px)"),
            a.length &&
              (n.dom.el.style[e.features.transformProp] = a.join(" ")),
        ...
        applyStylesOut: function (t) {
          ...
          if (
            ...
            n.push(
              i.writeTransitionRule(e.features.transformRule, t.staggerIndex)
            ),
            "none" !== t.statusChange &&
              n.push(
                i.writeTransitionRule("opacity", t.staggerIndex, t.duration)
              ),
            s &&
              (n.push(
                i.writeTransitionRule("width", t.staggerIndex, t.duration)
              ),
              n.push(
                i.writeTransitionRule("height", t.staggerIndex, t.duration)
              ),
              n.push(
                i.writeTransitionRule("margin", t.staggerIndex, t.duration)
              )),
            !t.callback)
          )
            return (
          ...
          switch (
            ...
            case "hide":
              r && (i.dom.el.style.opacity = i.mixer.effectsOut.opacity),
                (o = o.concat(i.mixer.transformOut));
              break;
            case "show":
              r && (i.dom.el.style.opacity = 1);
          }
          (i.mixer.config.animation.nudge ||
            (!i.mixer.config.animation.nudge && "hide" !== t.statusChange)) &&
            o.push("translate(" + t.posOut.x + "px, " + t.posOut.y + "px)"),
        ...
        writeTransitionRule: function (t, e, i) {
          ...
          return (
            (s =
              ...
              o +
              "ms " +
              ("opacity" === t ? "linear" : n.mixer.config.animation.easing)),
        ...
        getDelay: function (t) {
          ...
          return (
            ...
            (i = e.mixer.staggerDuration ? t * e.mixer.staggerDuration : 0),
            e.callFilters("delayGetDelay", i, arguments)
          );
        },
        applyTransition: function (t) {
          ...
          i.callActions("beforeApplyTransition", arguments),
            (i.dom.el.style[e.features.transitionProp] = n),
        ...
        getPosData: function (i) {
          ...
          return (
            ...
            (r.x = n.dom.el.offsetLeft),
            (r.y = n.dom.el.offsetTop),
    ...
    if (((t.console = t.console || { info: function (t) {} }), i))
      if (i.fn.fancybox) console.info("fancyBox already initialized");
        ...
        var o,
          ...
          v = function (t, e, n) {
            var o = this;
            (o.opts = g({ index: n }, i.fancybox.defaults)),
        ...
        i.extend(v.prototype, {
            ...
            i.each(s, function (t, e) {
              ...
              i.isPlainObject(e)
                ...
                d.opts.caption instanceof i ||
                  (d.opts.caption =
                    d.opts.caption === n ? "" : d.opts.caption + ""),
                "ajax" === d.type &&
          ...
          jumpTo: function (t, e) {
            ...
            if (
              ...
              if (
                ...
                return !1;
              if (
                ((o = h.firstRun = !Object.keys(h.slides).length),
                (l = h.current),
                (h.prevIndex = h.currIndex),
                (h.prevPos = h.currPos),
                (a = h.createSlide(t)),
                f > 1 &&
                  ((r || a.index < f - 1) && h.createSlide(t + 1),
                  (r || a.index > 0) && h.createSlide(t - 1)),
                (h.current = a),
                (h.currIndex = a.index),
                (h.currPos = a.pos),
                ...
                i.isNumeric(e)
                  ? (a.forcedDuration = e)
                  : (e =
                      a.opts[o ? "animationDuration" : "transitionDuration"]),
                (e = parseInt(e, 10)),
                (s = h.isMoved(a)),
          ...
          scaleToActual: function (t, e, o) {
            ...
            d.isAnimating ||
              ...
              (t = t === n ? 0.5 * h : t),
              (e = e === n ? 0.5 * f : e),
              ((s = i.fancybox.getTranslate(p)).top -= i.fancybox.getTranslate(
                u.$slide
              ).top),
          ...
          isScaledDown: function (t, e) {
            ...
            return (
              t !== n && e !== n
                ...
                : r &&
                  (o =
                    (o = i.fancybox.getTranslate(r)).width < s.width &&
                    o.height < s.height),
              o
            );
          },
            ...
            return (
              ...
              !1 === d.trigger("beforeClose", t)
                ...
                : (d.removeEvents(),
                  ...
                  (o = i.isNumeric(e) ? e : n ? u.opts.animationDuration : 0),
                  u.$slide.removeClass(
      ...
      (r = t.extend(!0, {}, e, s.opts.media)),
        t.each(r, function (e, n) {
          if ((l = h.match(n.matcher))) {
            if (
              ((f = n.type), (p = e), (u = {}), n.paramPlace && l[n.paramPlace])
            ) {
            ...
            return (
              (c = t.extend(!0, {}, n.params, s.opts[e], u)),
              (h =
    ...
    (c.prototype.destroy = function () {
        ...
        if (
          ...
          (o.realPoints = o.startPoints = s(n)),
            o.startPoints.length &&
              ...
              (((o.opts || o.canPan) &&
                (c.is(o.$stage) || o.$stage.find(c).length)) ||
      ...
      (c.prototype.limitMovement = function () {
        ...
        return (
          ...
          c > 0 && o > t && (o = t - 1 + Math.pow(-t + p + c, 0.8) || 0),
          c < 0 && o < i && (o = i + 1 - Math.pow(i - p - c, 0.8) || 0),
      ...
      focus: function (t) {
        ...
        o.instance.current &&
          ...
          (i.top < 0 || i.top > s.height() - e.outerHeight())
            ...
            : "x" === o.opts.axis &&
              (i.left < r.scrollLeft() ||
                i.left > r.scrollLeft() + (r.width() - e.outerWidth())) &&
  ...
  (function (t) {
    ...
    function d(i, a) {
      ...
      function _(t) {
        ...
        var e = t / p,
          i = e * f;
        e > 1 && (i += (Math.ceil(e) - 1) * g),
          E(a.ratedFill),
          (i = a.rtl ? 100 - i : i) < 0 ? (i = 0) : i > 100 && (i = 100),
          x.css("width", i + "%");
      }
      function S() {
        (v = h * a.numStars + m * (a.numStars - 1)),
          (f = (h / v) * 100),
          (g = (m / v) * 100),
          i.width(v),
          _();
      ...
      function T(t) {
        var e = (a.starWidth = t);
        return (
          (h = window.parseFloat(a.starWidth.replace("px", ""))),
          b.find("svg").attr({ width: a.starWidth, height: e }),
          x.find("svg").attr({ width: a.starWidth, height: e }),
          S(),
          i
        );
      }
      function k(t) {
        return (
          (a.spacing = t),
          (m = parseFloat(a.spacing.replace("px", ""))),
          b.find("svg:not(:first-child)").css({ "margin-left": t }),
          x.find("svg:not(:first-child)").css({ "margin-left": t }),
          S(),
          i
        );
      }
      function A(t) {
        return (
          (a.normalFill = t),
          (a.rtl ? x : b).find("svg").attr({ fill: a.normalFill }),
          i
        );
      }
      var $ = a.ratedFill;
      function E(t) {
        ...
        return (
          (a.ratedFill = t),
          (a.rtl ? b : x).find("svg").attr({ fill: a.ratedFill }),
          i
        );
      }
      function P(t) {
        (t = !!t), (a.rtl = t), A(a.normalFill), _();
      }
      function I(t) {
        (a.multiColor = t), E(t || $);
      }
      function D(n) {
        (a.numStars = n), (p = a.maxValue / a.numStars), b.empty(), x.empty();
        for (var o = 0; o < a.numStars; o++)
          b.append(t(a.starSvg || e)), x.append(t(a.starSvg || e));
        return T(a.starWidth), A(a.normalFill), k(a.spacing), _(), i;
      }
      function O(t) {
        return (
          (a.maxValue = t),
          (p = a.maxValue / a.numStars),
          a.rating > t && R(t),
          _(),
          i
        );
      ...
      function F(t) {
        return (a.precision = t), R(a.rating), i;
      }
      function M(t) {
      ...
      function R(t) {
        ...
        return (
          "string" == typeof e &&
            ("%" === e[e.length - 1] &&
              ((e = e.substr(0, e.length - 1)), O((n = 100))),
            (e = parseFloat(e))),
          (function (t, e, i) {
            if (!(t >= e && t <= i))
              throw Error(
          ...
          (a.rating = e),
          _(),
          C && i.trigger("rateyo.set", { rating: e }),
          i
        );
      }
      function H(t) {
      ...
      function z(t) {
        var e = j(t).toFixed(a.precision),
          n = a.maxValue;
        _((e = s(parseFloat(e), 0, n))),
          i.trigger("rateyo.change", { rating: e });
      }
      function W() {
        var t, e;
        ((e = !1),
        ...
        (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(
          ...
          (e = !0),
        e) || (_(), i.trigger("rateyo.change", { rating: a.rating }));
      }
      function U(t) {
        var e = j(t).toFixed(a.precision);
      ...
      function X(t, e) {
        a.onInit &&
          "function" == typeof a.onInit &&
          a.onInit.apply(this, [e.rating, u]);
      }
      function Y(t, e) {
        a.onChange &&
          "function" == typeof a.onChange &&
          a.onChange.apply(this, [e.rating, u]);
      }
      function V(t, e) {
        a.onSet &&
          "function" == typeof a.onSet &&
          a.onSet.apply(this, [e.rating, u]);
      }
      function G() {
        i.off("mousemove", z)
          .off("mouseenter", z)
      ...
      (this.rating = function (t) {
        return r(t) ? (R(t), i) : a.rating;
      }),
        (this.destroy = function () {
          var e, n;
          return (
            a.readOnly || G(),
            (d.prototype.collection =
              ((e = i.get(0)),
              (n = this.collection),
              t.each(n, function (t) {
                if (e === this.node) {
        ...
        this.rating(a.rating, !0),
        (C = !0),
        i.trigger("rateyo.init", { rating: a.rating });
    }
    function u(e, i) {
      var n;
      return (
    ...
    function p(e) {
      ...
      if (0 === s.length) e = s[0] = {};
        ...
        if (1 !== s.length || "object" != typeof s[0]) {
          if (s.length >= 1 && "string" == typeof s[0]) {
            var r = s[0],
              a = s.slice(1),
              l = [];
            return (
  ...
  (function (t) {
    ...
    function i(i, n) {
      ...
      void 0 !== this.options.locales[o] &&
        t.extend(this.options, this.options.locales[o]),
        this.init();
    }
    function n(e) {
      if (
        !t(e.target).parents().hasClass("jq-selectbox") &&
        "OPTION" != e.target.nodeName &&
        t("div.jq-selectbox.opened").length
      ) {
        var i = t("div.jq-selectbox.opened"),
          n = t("div.jq-selectbox__search input", i),
          o = t("div.jq-selectbox__dropdown", i);
        i.find("select").data("_styler").options.onSelectClosed.call(i),
    ...
    (i.prototype = {
        ...
        if (e.is(":checkbox")) {
          var a = function () {
            var i = new r(),
              n = t(
                ...
                .addClass(i.classes)
                .data(i.data);
            e.after(n).prependTo(n),
              e.is(":checked") && n.addClass("checked"),
              e.is(":disabled") && n.addClass("disabled"),
              n.click(function (t) {
                t.preventDefault(),
                  e.triggerHandler("click"),
                  n.is(".disabled") ||
                    (e.is(":checked")
                      ? (e.prop("checked", !1), n.removeClass("checked"))
                      : (e.prop("checked", !0), n.addClass("checked")),
                    e.focus().change());
              }),
              e
                .closest("label")
              ...
              e
                .on("change.styler", function () {
                  ...
                  if (e.is("[multiple]")) {
                    ...
                    if (n > 0) {
                      var s = e.data("number");
                      void 0 === s && (s = i.fileNumber),
                        (t = s = s.replace("%s", n));
                    }
                  }
                  c.text(t.replace(/.+[\\\/]/, "")),
                    "" === t
                      ? (c.text(o), a.removeClass("changed"))
                      : a.addClass("changed");
                })
                .on("focus.styler", function () {
                  a.addClass("focused");
          ...
          var d = function () {
            ...
            var o,
              ...
              l = null,
              c = null;
            void 0 !== e.attr("min") && (o = e.attr("min")),
              void 0 !== e.attr("max") && (s = e.attr("max")),
              (a =
                void 0 !== e.attr("step") && t.isNumeric(e.attr("step"))
                  ? Number(e.attr("step"))
                  : Number(1));
            var d = function (i) {
              var n,
                r = e.val();
              t.isNumeric(r) || ((r = 0), e.val("0")),
                i.is(".minus")
                  ? (n = Number(r) - a)
                  : i.is(".plus") && (n = Number(r) + a);
              var l = (a.toString().split(".")[1] || []).length;
              if (l > 0) {
                for (var c = "1"; c.length <= l; ) c += "0";
                n = Math.round(n * c) / c;
              }
              t.isNumeric(o) && t.isNumeric(s)
                ? n >= o && n <= s && e.val(n)
                : t.isNumeric(o) && !t.isNumeric(s)
                ? n >= o && e.val(n)
                : !t.isNumeric(o) && t.isNumeric(s)
          ...
          var u = function () {
            function a(t) {
              ...
              t.off("mousewheel DOMMouseScroll").on(
                ...
                function (o) {
                  (i =
                    o.originalEvent.detail < 0 || o.originalEvent.wheelDelta > 0
                      ? 1
                      : -1),
                    (((n = t.scrollTop()) >= e && i < 0) ||
                      (n <= 0 && i > 0)) &&
            ...
            function d() {
              for (var t = 0; t < l.length; t++) {
                ...
                e.prop("selected") && (o = "selected sel"),
                  ...
                  void 0 !== e.attr("id") &&
                    "" !== e.attr("id") &&
                    (r = ' id="' + e.attr("id") + i.idSuffix + '"'),
                  void 0 !== e.attr("title") &&
                    "" !== l.attr("title") &&
                    (a = ' title="' + e.attr("title") + '"'),
                  void 0 !== e.attr("class") &&
                    ((u = " " + e.attr("class")),
                    (h = ' data-jqfs-class="' + e.attr("class") + '"'));
                var f = e.data();
                for (var m in f)
                  "" !== f[m] && (d += " data-" + m + '="' + f[m] + '"');
                o + u !== "" && (s = ' class="' + o + u + '"'),
                  (n = "<li" + h + d + s + a + r + ">" + e.html() + "</li>"),
                  e.parent().is("optgroup") &&
                    (void 0 !== e.parent().attr("class") &&
                      (p = " " + e.parent().attr("class")),
                    (n =
                      "<li" +
                      h +
                      d +
            ...
            if (e.is("[multiple]")) {
              ...
              !(function () {
                var i = new r(),
                  n = t('<div class="jq-select-multiple jqselect"></div>')
                    .attr({ id: i.id, title: i.title })
                    .addClass(i.classes)
                    .data(i.data);
                ...
                void 0 !== u && u > 0
                  ...
                  p > n.height() &&
                    ...
                    a(o),
                    s.filter(".selected").length &&
                      o.scrollTop(
                        o.scrollTop() + s.filter(".selected").position().top
                      )),
                  e.prependTo(n),
                  e.is(":disabled")
                    ? (n.addClass("disabled"),
                      l.each(function () {
                        t(this).is(":selected") &&
                          s.eq(t(this).index()).addClass("selected");
                      }))
                    : (s
                        ...
                        .click(function (i) {
                          ...
                          var n = t(this);
                          if (
                            (i.ctrlKey || i.metaKey || n.addClass("selected"),
                            i.shiftKey || n.addClass("first"),
                            i.ctrlKey ||
                              i.metaKey ||
                              i.shiftKey ||
                      ...
                      p > n.height() &&
                        e.on("keydown.styler", function (t) {
                          (38 != t.which && 37 != t.which && 33 != t.which) ||
                            o.scrollTop(
                              o.scrollTop() +
                                s.filter(".selected").position().top -
                                h
                            ),
                            (40 != t.which && 39 != t.which && 34 != t.which) ||
                              o.scrollTop(
                                o.scrollTop() +
                                  s.filter(".selected:last").position().top -
                                  o.innerHeight() +
                                  2 * h
                              );
                        }));
              ...
              !(function () {
                ...
                void 0 === p && (p = i.selectPlaceholder),
                  (void 0 !== h && "" !== h) || (h = i.selectSearch),
                  (void 0 !== f && "" !== f) || (f = i.selectSearchLimit),
                  (void 0 !== m && "" !== m) || (m = i.selectSearchNotFound),
                  void 0 === g && (g = i.selectSearchPlaceholder),
                  (void 0 !== v && "" !== v) || (v = i.selectSmartPositioning);
                var y = t(
                ...
                var S = t("ul", _),
                  T = t("li", _),
                  k = t("input", _),
                  A = t("div.jq-selectbox__not-found", _).hide();
                T.length < f && k.parent().hide(),
                  "" === l.first().text() &&
                  l.first().is(":selected") &&
                  !1 !== p
                    ? w.text(p).addClass("placeholder")
                    : w.text(C.text());
                var $ = 0,
                  E = 0;
                if (
                  ...
                  T.each(function () {
                    var e = t(this);
                    e.innerWidth() > $ &&
                      (($ = e.innerWidth()), (E = e.width()));
                  }),
                  T.css({ display: "" }),
                  w.is(".placeholder") && w.width() > $)
                )
                  w.width(w.width());
                else {
                  var P = y.clone().appendTo("body").width("auto"),
                    I = P.outerWidth();
                  P.remove(), I == y.outerWidth() && w.width(E);
                }
                $ > y.width() && _.width($),
                  "" === l.first().text() &&
                    "" !== e.data("placeholder") &&
                ...
                if (
                  ...
                  var N = T.outerHeight();
                  !1 !== p && (N = T.eq(1).outerHeight()),
                    T.data("li-height", N);
                }
                var j = _.css("top");
                if (
                  ("auto" == _.css("left") && _.css({ left: 0 }),
                  "auto" == _.css("top") && (_.css({ top: D }), (j = D)),
                  _.hide(),
                  M.length &&
                    (l.first().text() != C.text() && y.addClass("changed"),
                    y.data("jqfs-class", M.data("jqfs-class")),
                    y.addClass(M.data("jqfs-class"))),
                  e.is(":disabled"))
                )
                  return y.addClass("disabled"), !1;
                x.click(function () {
                  if (
                    (t("div.jq-selectbox").filter(".opened").length &&
                      i.onSelectClosed.call(
                        t("div.jq-selectbox").filter(".opened")
                      ),
                    e.focus(),
                    !o)
                  ) {
                    ...
                    var h = function () {
                      _.height("auto").css({ bottom: "auto", top: j });
                      var t = function () {
                        S.css("max-height", Math.floor((c - 20 - O) / s) * s);
                      };
                      t(),
                        S.css("max-height", p),
                        "none" != F && S.css("max-height", F),
                        c < _.outerHeight() + 20 && t();
                    };
                    !0 === v || 1 === v
                      ? c > u + O + 20
                        ? (h(), y.removeClass("dropup").addClass("dropdown"))
                        : ((function () {
                            _.height("auto").css({ top: "auto", bottom: j });
                            var t = function () {
                              S.css(
                                "max-height",
                                Math.floor((r - n.scrollTop() - 20 - O) / s) * s
                              );
                            };
                            t(),
                              S.css("max-height", p),
                              "none" != F && S.css("max-height", F),
                              r - n.scrollTop() - 20 < _.outerHeight() + 20 &&
                                t();
                          })(),
                          y.removeClass("dropdown").addClass("dropup"))
                      : !1 === v || 0 === v
                      ? c > u + O + 20 &&
                        (h(), y.removeClass("dropup").addClass("dropdown"))
                      : (_.height("auto").css({ bottom: "auto", top: j }),
                        S.css("max-height", p),
                        "none" != F && S.css("max-height", F)),
                      y.offset().left + _.outerWidth() > n.width() &&
                        _.css({ left: "auto", right: 0 }),
                      t("div.jqselect")
                        .css({ zIndex: b - 1 })
                        .removeClass("opened"),
                      y.css({ zIndex: b }),
                      _.is(":hidden")
                        ? (t("div.jq-selectbox__dropdown:visible").hide(),
                          _.show(),
                          y.addClass("opened focused"),
                          i.onSelectOpened.call(y))
                        : (_.hide(),
                  ...
                  T.filter(":not(.disabled):not(.optgroup)").click(function () {
                    ...
                    if (!n.is(".selected")) {
                      var s = n.index();
                      (s -= n.prevAll(".optgroup").length),
                        n
                          .addClass("selected sel")
                          .siblings()
                          .removeClass("selected sel"),
                        l.prop("selected", !1).eq(s).prop("selected", !0),
                        w.text(o),
                        y.data("jqfs-class") &&
                          y.removeClass(y.data("jqfs-class")),
                        y.data("jqfs-class", n.data("jqfs-class")),
                        y.addClass(n.data("jqfs-class")),
                        e.change();
                    }
                    _.hide(),
                      y.removeClass("opened dropup dropdown"),
                  ...
                  _.mouseout(function () {
                    t("li.sel", _).addClass("selected");
                  }),
                  e
                    .on("change.styler", function () {
                      w
                        .text(l.filter(":selected").text())
                        .removeClass("placeholder"),
                        T.removeClass("selected sel")
                          .not(".optgroup")
                          .eq(e[0].selectedIndex)
                          .addClass("selected sel"),
                        l.first().text() != T.filter(".selected").text()
                          ? y.addClass("changed")
                  ...
                  n.registered ||
                    (t(document).on("click", n), (n.registered = !0));
              })();
          };
          u(),
            e.on("refresh", function () {
      ...
      (t.fn.styler = function (e) {
        ...
        return void 0 === e || "object" == typeof e
          ? (this.each(function () {
              t.data(this, "_styler") ||
                t.data(this, "_styler", new i(this, e));
            })
              .promise()
              .done(function () {
          ...
          ? (this.each(function () {
              ...
              s instanceof i &&
                "function" == typeof s[e] &&
                (n = s[e].apply(s, Array.prototype.slice.call(o, 1)));
            }),
            void 0 !== n ? n : this)
          : void 0;
      }),
  ...
  (function (t) {
    ...
    var c = function (n, s, r) {
      ...
      "INPUT" !== d[0].nodeName &&
        console &&
        console.warn &&
        console.warn("Base element should be <input>!", d[0]),
      ((l = {
        skin: d.data("skin"),
        type: d.data("type"),
        min: d.data("min"),
      ...
      u !== o &&
        "" !== u &&
        ((u = u.split(
          l.input_values_separator || s.input_values_separator || ";"
        ))[0] &&
          u[0] == +u[0] &&
          (u[0] = +u[0]),
        u[1] && u[1] == +u[1] && (u[1] = +u[1]),
        s && s.values && s.values.length
          ? ((a.from = u[0] && s.values.indexOf(u[0])),
            (a.to = u[1] && s.values.indexOf(u[1])))
    ...
    (c.prototype = {
            ...
            if ("single" === this.options.type)
              ...
              s
                ...
                : ((n = this._prettify(this.result.from)),
                  ...
                  (i = this.decorate(o, this.result.to)),
                  this.$cache.single.html(t),
                  this.$cache.from.html(e),
                  this.$cache.to.html(i)),
                this.calcLabels();
      ...
      convertToValue: function (t) {
        ...
        return (
          u
            ? (d = +d.toFixed(u.length))
            : ((d /= this.options.step),
              (d = +(d *= this.options.step).toFixed(0))),
          l && (d -= l),
          (c = u ? +d.toFixed(u.length) : this.toFixed(d)) < this.options.min
            ? (c = this.options.min)
      ...
      checkEdges: function (t, e) {
        return this.options.force_edges
          ? (t < 0 ? (t = 0) : t > 100 - e && (t = 100 - e), this.toFixed(t))
          : this.toFixed(t);
      },
      validate: function () {
        var t,
        ...
        if (
          ...
          for (
            ...
            (t = +o[e]),
              isNaN(t) ? (t = o[e]) : ((o[e] = t), (t = this._prettify(t))),
              i.p_values.push(t);
  ...
  $(function () {
    $(".top-slider__inner").slick({ slidesToShow: 1, arrows: !1, dots: !0 }),
      $(".details-slider").slick({
        slidesToShow: 4,
        prevArrow:
          '<button class="slider-left"><img src="images/slider-left.svg"></button>',
        nextArrow:
          '<button class="slider-right"><img src="images/slider-right.svg"></button>',
      }),
      ...
      $(".details__content-num").styler(),
      $(".menu-btn").on("click", function () {
        $(".menu__list").slideToggle();
        $(this).toggleClass("active");
        if ($(this).hasClass("active")) {
          $(this).find("span:nth-child(3)").hide(); // Menampilkan ikon tanda X
          $(".menu__list").css("display", "flex");
        } else {
          $(this).find("span:nth-child(3)").show(); // Menyembunyikan ikon tanda X
          $(".menu__list").css("display", "none");
        }
      }),
      $(".settings-btn").on("click", function () {
        $(".blog-aside").slideToggle();
      });
  });
